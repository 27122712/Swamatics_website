...
const HomePagev2 = () => {
  ...
  const blowerImages = [
    ...
    "/images/Process-Gas-BlowersGas-Boosters.webp",
    "/images/Turbo_Blowers.webp",
    "/images/SuperHelicalHybridBlower.webp",
    "/images/Truck-Blowers.png",
    "/images/sR-Series-Blowers.webp",
    "/images/swam-centrifugal-fans-and-blowers.webp",
    "/images/VacuumPumpsWithSecondarySuction.png",
  ];
  const vaccumImages = [
    "/images/dry-Screw-Vacuum-Pump.png",
    "/images/liquid-Ring-Vacuum-Pump.webp",
    "/images/oil-Vane-Vacuum-Pump.webp",
    "/images/Mechanical-Vacuum.webp",
    "/images/Vacuum-Systems-Packages.png",
    "/images/MVR-Blowers.webp",
    "/images/Condenser-Exhausters.webp",
  ];
  const otherImages = [
    "/images/bio-Gas-Blowers-Compressors.webp",
    "/images/rotary-Sliding-Vane-Compressors.webp",
  ];
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="text-center max-w-5xl mx-auto w-full">
            <div className="mb-6 sm:mb-8">
              <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight tracking-tight px-2">
                Engineering
              ...
              {/* <p className="text-sm sm:text-base md:text-xl lg:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed mb-6 sm:mb-8 px-4">
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <option value="Bio Gas Compressors">Bio Gas Blowers</option>
      ...
      <section className="py-7 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 md:mb-8 leading-tight tracking-tight">
            ...
            <span className="block sm:inline"> into Solutions</span>
          </h2>
            ...
            {[
              {
                ...
                desc: "Carbon capture reinvented through innovative vacuum systems.",
                bgImage: "/images/Carbon Capture.png",
              },
              {
                title: "Cryogenics",
                desc: "Vacuum solutions enabling cryogenic breakthroughs.",
                bgImage: "/images/Cryogenics.png",
              },
              {
                title: "Solar",
                desc: "Harnessing the sun with vacuum precision.",
                bgImage: "/images/Solar.png",
              },
              {
                title: "Semiconductor",
                desc: "Vacuum innovation for scalable semiconductor production.",
                bgImage: "/images/Semiconductor.png",
              },
              {
                title: "Steel Degassing",
                desc: "Vacuum degassing for hydrogen-free steel.",
              ...
              {[
                {
                  title: "Innovation",
                  description:
                    "Innovation is more than an idea—it's a mindset. A relentless drive to think differently, to break boundaries, and to create what's next.",
                ...
                },
                {
                  title: "Technology",
                  description:
                    "Technology is the bridge between imagination and reality. It powers progress, connects the world, and transforms how we live and work.",
                ...
                },
                {
                  title: "Excellence",
                  description:
                    "Excellence isn't a destination. It's a commitment—reflected in every detail, every decision, every outcome.",
                ...
                },
                {
                  ...
                  description:
                    "Sustainability is our promise to the future. To innovate responsibly. To grow with purpose. To leave a world better than we found it.",
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-gray-400 text-sm">
                      We're available from 9 AM to 6 PM, Monday to Saturday
                    </span>
                  </div>
                </div>
