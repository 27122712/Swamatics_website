    ...
    <MainTemplate>
      <section className="relative bg-gradient-to-r from-blue-700 to-blue-500 text-white py-25 mt-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-5xl font-extrabold mb-6">HVAC Systems</h1>
          <p className="text-lg max-w-2xl mx-auto opacity-90">
            Delivering efficient solutions for heating, ventilation, and air conditioning systems.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {/* ✅ Benefits Section */}
        <div className="bg-gradient-to-r from-red-50 to-red-100 p-8 rounded-xl shadow-md mb-12">
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-gray-700 text-lg text-center">
            {benefits.map((benefit, index) => (
              <li
                key={index}
                className="bg-white p-4 rounded-lg shadow-sm border border-gray-200 hover:border-red-400 transition"
              >
                ✅ {benefit}
              </li>
            ))}
      ...
      {/* Product Grid - centered product names */}
